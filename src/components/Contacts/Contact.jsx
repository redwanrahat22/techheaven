...
const Contact = () => {
    ...
    return (
        <div className="h-screen mt-24 w-11/12 m-auto">
                <div >
                    <h1 className={`text-center text-3xl ${screenmode ? " text-dmgreen" : "text-lmblue "}`}>Contact Us</h1>
                </div>

                <div className={`grid grid-cols-4 mt-20 w-4/5 ml-52 `}>
