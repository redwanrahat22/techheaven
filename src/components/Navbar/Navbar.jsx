...
const Navbar = () => {
    ...
    const links = <>
          <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative ${screenmode ? 'hover:text-dmgreen': 'hover:text-lmblue'}`  }   ><NavLink className={({isActive})=> isActive ? (` lg:border-t-4 md:border-none  inline-block ${screenmode ? 'border-dmgreen' : 'border-lmblue'} text-${colormode} ` ) :`lg:border-t-4 md:border-none inline-block border-transparent` }  to={'/'} ><h1 className={` hover:scale-105 duration-200 ${scroll ? 'lg:mt-7 ml-3 lg:ml-0 mt-1' : 'lg:mt-11  mt-1 ml-3 md:ml-3 lg:ml-0'} text-[12px] md:text-[17px] `}>Home</h1></NavLink></li>
          <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative hover:text-${colormode}  ` }   ><NavLink className={({isActive})=>  isActive ? (` lg:border-t-4 md:border-none  inline-block ${screenmode ? 'border-dmgreen' : 'border-lmblue'} text-${colormode} ` ) :`lg:border-t-4 md:border-none inline-block border-transparent`  }  to={'/addproduct'} ><h1 className={`whitespace-nowrap hover:scale-105 duration-200 ${scroll ? 'lg:mt-7 ml-3 lg:ml-0 mt-1' : 'lg:mt-11  mt-1 ml-3 md:ml-3 lg:ml-0'} text-[12px] md:text-[17px] `}>Add Product</h1></NavLink></li>
          <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative hover:text-${colormode}  ` }   ><NavLink className={({isActive})=>  isActive ? (` lg:border-t-4 md:border-none  inline-block ${screenmode ? 'border-dmgreen' : 'border-lmblue'} text-${colormode} ` ) :`lg:border-t-4 md:border-none inline-block border-transparent`  }  to={'/blog'} ><h1 className={` hover:scale-105 duration-200 ${scroll ? 'lg:mt-7 ml-3 lg:ml-0 mt-1' : 'lg:mt-11  mt-1 ml-3 md:ml-3 lg:ml-0'} text-[12px] md:text-[17px] `}>Blog</h1></NavLink></li>
          <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative hover:text-${colormode}  ` }   ><NavLink className={({isActive})=>  isActive ? (` lg:border-t-4 md:border-none  inline-block ${screenmode ? 'border-dmgreen' : 'border-lmblue'} text-${colormode} ` ) :`lg:border-t-4 md:border-none inline-block border-transparent`  }  to={'/contact'} ><h1 className={` hover:scale-105 duration-200 ${scroll ? 'lg:mt-7 ml-3 lg:ml-0 mt-1' : 'lg:mt-11  mt-1 ml-3 md:ml-3 lg:ml-0'} text-[12px] md:text-[17px] `}>Contact</h1></NavLink></li>
          ...
          <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative hover:text-${colormode}  ` }   ><NavLink className={({isActive})=>  isActive ? (` lg:border-t-4 md:border-none  inline-block ${screenmode ? 'border-dmgreen' : 'border-lmblue'} text-${colormode} ` ) :`lg:border-t-4 md:border-none inline-block border-transparent`  }  to={'/cart'} ><h1 className={` hover:scale-105 duration-200 ${scroll ? 'lg:mt-6 md:mt-4 mt-2 ml-3 md:ml-4 lg:ml-0' : 'lg:mt-10 md:mt-4 mt-2 ml-3 md:ml-4  lg:ml-0'}`}>
...

          {
              ...
              user ? 
              <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative hover:text-${colormode}  ` } onClick={handleSigningOUt}   ><NavLink className={({isActive})=>  isActive ? (` lg:border-t-4 md:border-none  inline-block border-transparent ` ) :`lg:border-t-4 md:border-none inline-block border-transparent`  }  to={''} ><h1 className={`${scroll ? 'lg:mt-6 md:mt-7 mt-3' : 'lg:mt-10 md:mt-7 mt-3'} whitespace-nowrap text-center w-1/3 md:w-24 lg:w-auto ml-3 lg:ml-0  text-[12px] md:text-[17px] lg:px-4 hover:scale-110 duration-200 rounded-sm ${screenmode ? 'bg-dmgreen text-black' : 'bg-lmblue text-white'} md:py-2 text-white pb-1 lg:pb-0 lg:py-1 `}>Sign Out</h1></NavLink></li> :
              
              <li className={`${scroll ? 'lg:h-20  md:h-12 ' : ' md:h-12 lg:h-28'} duration-150  relative hover:text-${colormode}  ` }   ><NavLink className={({isActive})=>  isActive ? (` lg:border-t-4 md:border-none  inline-block ${screenmode ? 'border-dmgreen' : 'border-lmblue'} text-${colormode} ` ) :`lg:border-t-4 md:border-none inline-block border-transparent`  }  to={'/login'} ><h1 className={`${scroll ? 'lg:mt-6 md:mt-7 mt-3' : 'lg:mt-10 md:mt-7 mt-3'} whitespace-nowrap text-center w-1/3 md:w-24 lg:w-auto ml-3 lg:ml-0  text-[12px] md:text-[17px] lg:px-4 hover:scale-110 duration-200 rounded-sm ${screenmode ? 'bg-dmgreen text-black ' : 'bg-lmblue text-white'} md:py-2 text-white pb-1 lg:pb-0 lg:py-1`}>Login</h1></NavLink></li> 
          }

        <div onClick={handleMode} className={`${scroll ? 'lg:mt-6 mt-4 md:mt-10': 'lg:mt-10 md:mt-10 mt-4'} hover:cursor-pointer duration-200 `}>
