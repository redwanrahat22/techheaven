                ...
                <div className="md:mt-20 -mt-8">
                    ...
                    <div className=" md:w-2/3 w-10/12 m-auto space-y-4 md:space-y-12">
                      ...
                      <div className="md:space-y-7 space-y-8 ">
                        ...
                        <div className={`md:w-1/4 pt-8 md:pt-0 w-3/4  mx-auto ${screenmode ? '' : ''}`}>
                            ...
                            <ul className="list-disc list-inside mt-6 space-y-4 font-page">
                                {
                                    ...
                                    <li key={data.prodID} className=" items-center ">{data.prodName} </li>
                                ...
                                <div className="w-11/12 m-auto pt-8 flex justify-between font-bold">
                                  ...
                                  <button className={`md:w-1/3 text-white py-1 rounded-md md:rounded-full hover:scale-125 ease-in-out duration-300 m-auto block mt-8 px-4 md:px-2 ${screenmode? 'bg-dmgreen' : 'bg-lmblue'}`}>Pay Now</button>
                        </div>
