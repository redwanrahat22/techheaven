    ...
    return (
        <div className="h-screen ">
           ...
           <hr className={`mt-4 ${screenmode ? 'bg-dmgreen' : 'bg-lmblue ' } border-dashed`} />
            <form onSubmit={handleLogin} action="" className="w-[390px] m-auto  mt-12 space-y-4 ">
                ...
                <div className="space-x-28 flex items-center">
                    ...
                    <input type="email" name="email" required className={` ${screenmode ? 'bg-slate-700 border-white text-white focus:border-dmgreen' : 'bg-[#eff4fd] border-slate-300 text-black focus:border-lmblue '} py-1 border-2 px-2  font-menu focus:outline-none rounded-md `} required />
                    </div>
                </div>
                ...
                <div className="space-x-[78px] flex items-center">
                    ...
                    <div className="flex space-x-2 items-center relative">
                        <h3 className="font-semibold font-menu ">:</h3>
                    <input type={`${showpass ? 'text' : 'password'}`} name="password" required className={` ${screenmode ? 'bg-slate-700 border-white text-white focus:border-dmgreen' : 'bg-[#eff4fd] border-slate-300 text-black focus:border-lmblue '} py-1 border-2 px-2  font-menu focus:outline-none rounded-md`} required />
